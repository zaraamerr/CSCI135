...
int main (){
    ...
    int cost_per_100_miles; //creates a var that will store the calculation of how much it costs to travel 100 miles
    ...
    cost_per_100_miles= (price * 100 / miles_per_gallon); //set var cost_per_100 miles to a calculation that multiplies the price by 100 and divides it by how many miles can be traveled per gallon to determine what the cost is to travel 100 miles
