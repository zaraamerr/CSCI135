...
int main (){
    ...
    cost_per_100_miles= (100.0 / miles_per_gallon * price_per_gallon); //set var cost_per_100 miles to a calculation that multiplies the price by 100 and divides it by how many miles can be traveled per gallon to determine what the cost is to travel 100 miles
